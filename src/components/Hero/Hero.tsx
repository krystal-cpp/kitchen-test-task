    ...
    return(
        <div className='w-full px-5 lg:px-12'>
            ...
            <div className='flex flex-col'>
                ...
                <button type='button' onClick={scrollToBookingForm} className='bg-[#C45C3E] hover:bg-[#A84B31] rounded-lg text-white text-base lg:text-lg font-medium flex items-center justify-center w-fit px-5 lg:px-8 py-3 mt-5'>Забронировать стол</button>
            </div>
        </div>
    );
};